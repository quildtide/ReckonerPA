...
function calc_rating_hist(matches::PAMatches, eval_time::Dates.DateTime, player_type::String, player_id::String, reckoner_version = "0.9.0")
...
function calc_rating_hist(player_type::String, player_id::String, eval_time::Dates.DateTime = Dates.now(), reckoner_version = "0.9.0")
...
function calc_rating_hist_remote(ip_addr, player_type::String, player_id::String, eval_time::Dates.DateTime = Dates.now(), reckoner_version = "0.9.0")
